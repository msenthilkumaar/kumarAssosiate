<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="Attendence.aspx.cs" Inherits="Attendence" %>
        ...
        <asp:TemplateField>
         <ItemTemplate>
                <asp:Image ID="Image1" runat="server" Height="50px" 
                                ImageUrl='<%#Eval("Imgrid")%>' Width="50px" />
