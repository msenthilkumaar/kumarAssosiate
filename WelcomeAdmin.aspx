<%@ Page Title="" Language="C#" MasterPageFile="~/SubAdmin.master" AutoEventWireup="true" CodeFile="WelcomeAdmin.aspx.cs" Inherits="WelcomeAdmin" %>
     ...
     <div class="demo-container no-bg">
        <telerik:RadScheduler runat="server" ID="RadScheduler1" AdvancedForm-Enabled="true"
            ...
            OverflowBehavior="Auto" Height="" DataDescriptionField="Remarks" 
             ...
             SelectedView="MonthView" AllowDelete="false" AllowInsert="true" 
             EnableTheming="False">
             <%--<ResourceStyles>
