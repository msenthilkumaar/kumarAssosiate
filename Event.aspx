<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="Event.aspx.cs" Inherits="Event" EnableEventValidation="false" %>
...
<telerik:RadTimePicker RenderMode="Lightweight" ID="RadTimePicker1" runat="server"  DateInput-Label="Start@:"
  ...
  <br />  <br />
   ...
   <br />
    ...
    <asp:Label 
        ID="dateCrct" runat="server" Text="" Visible="true"></asp:Label>
    <br />
    ...
    <asp:TextBox ID="txtMessages" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
    <br />
