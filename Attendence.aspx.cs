...
using System.Data;
public partial class Attendence : Telerik.Web.UI.RadAjaxPage 
{
    DbCon db = new DbCon();
    ...
    private void loadGrids(string eventID)
    {
        ...
        DataColumn newCol = new DataColumn("Imgrid", typeof(string));
        newCol.AllowDBNull = false;
        dt.Columns.Add(newCol);
        foreach (DataRow row in dt.Rows)
        {
            row["Imgrid"] = "~/Photos/" + Convert.ToString(row["rid"]) +".jpg";
        }
